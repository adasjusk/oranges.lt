<div class="page-title">
  <img src="https://oranges.lt/img/orangescp.png" alt="Orange SCP" class="title-icon"> 
  <h1>Orange SCP</h1>
</div>

<div class="page-title">
  <h2>Welcome to the Orange SCP:SL Official Wiki!</h2>
</div>

<div class="centered-content">
</div>

<img src="https://oranges.lt/img/scp.png" alt="Made by Jamintheinfinite" class="scp-background-img" style="position: fixed; right: -1%; bottom: 20; width: 20%; height: auto; z-index: 0; border: none; box-shadow: none; outline: none; display: block;">
